...
const Modal: React.FC<ModalProps> = ({ handleModalClose }) => {
    ...
    return (
        <div className=" absolute z-100 top-0 left-0 " >
            ...
            <div className="w-[80vw] md:w-[30vw] md:max-w-[40vw]  md:h-[400px] h-[400px] rounded bg-gray-100 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-30 border border-gray-400 text-white  absolute md:top-[50%] top-[30%] left-[50%] translate-x-[-50%] translate-y-[-50%] p-10 md:p-12 flex flex-col justify-between items-end shadow-2xl">
                <div className="w-full flex flex-col gap-4  ">
                    <div className="text-lg  w-full">
                        <div className="w-full text-sm">Name: </div>
                        <div className="text-xl font-semibold w-full">
                            <input className=" bg-transparent border-b outline-none border-gray-800 px-2 py-1 text-lg w-full" value={user?.name} type="text" name="name" onChange={handleChange} />
                        </div>
                    </div>
                    <div className="text-lg  w-full">
                ...
                <div className="flex gap-4 text-sm">
                    <div className="bg-gray-800 hover:bg-gray-900 text-white rounded-md p-2 px-4 w-auto cursor-pointer" onClick={HandleSignup}>Sign up</div>
                </div>
            </div>
        </div>
    )
